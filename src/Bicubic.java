...
public class Bicubic {
    ...
    public static double[][] matriksBicubic() {
    ...
    public static double[][] matriksKali(double[][] A, double[][]B, int m, int n, int r) {
        // m = baris matriks 1
        // n = kolom matriks 2
    ...
    public static double[][] matriksTranspose(double[][] A, int baris, int kolom) {
        // Melakukan loop sepanjang elemen
        int i, j;
        // Inisiasi matriks
    ...
    public static double[][] matriksConvert(double[][] mat, int baris1, int kolom1, int baris2, int kolom2) {
